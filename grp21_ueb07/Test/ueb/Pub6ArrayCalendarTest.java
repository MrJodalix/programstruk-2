 ...
 * @author klk
 */
public class Pub6ArrayCalendarTest {

    /**
     * Test of getIntervalCount method, of class ArrayCalendar.
     */
    @Test
    public void testGetIntervalCount_EmptyCalendar() {
        Calendar c = new ArrayCalendar("test");
        assertEquals(0, c.getIntervalCount());
    }

    @Test
    public void testGetIntervalCount_TwoElements() throws ParseException {
        Calendar c = new ArrayCalendar("test", "01.01.2020", "01.02.2020",
                                  "01.03.2020", "01.04.2020");
        assertEquals(2, c.getIntervalCount());
    }

    /**
     * Test of getInterval method, of class ArrayCalendar.
     */
    @Test
    ...
    /**
     * Test of equals method, of class ArrayCalendar.
     */
    @Test
    public void testEquals_FourSameElements() throws ParseException {
        Calendar c1 = new ArrayCalendar("test", "01.01.2020", "01.02.2020",
                                     "01.03.2020", "01.04.2020",
                                     "01.05.2020", "01.06.2020",
                                     "01.07.2020", "01.08.2020");
        Calendar c2 = new ArrayCalendar("test", "01.01.2020", "01.02.2020",
                                     "01.03.2020", "01.04.2020",
                                     "01.05.2020", "01.06.2020",
                                     "01.07.2020", "01.08.2020");
    ...
    public void testEquals_FirstOfThreeDiffers() throws ParseException {
        Calendar c1 = new ArrayCalendar("test", "01.01.2020", "01.02.2020",
                                     "01.03.2020", "01.04.2020",
                                     "01.05.2020", "01.06.2020");
        Calendar c2 = new ArrayCalendar("test", "02.01.2020", "01.02.2020",
                                     "01.03.2020", "01.04.2020",
                                     "01.05.2020", "01.06.2020");
    ...
    /**
     * Test of toString method, of class ArrayCalendar.
     */
    @Test
    public void testToString_IsSurroundedByCurlyBracketAndBlank() throws ParseException {
        Calendar c = new ArrayCalendar("test", "01.03.2020", "01.04.2020");
