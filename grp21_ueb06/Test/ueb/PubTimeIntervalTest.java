...
/**
 * Tests of class TimeInterval.
 * @author klk
 */
public class PubTimeIntervalTest {
...
//<editor-fold defaultstate="expanded" desc="constructor tests">
    ...
    public void testConstructor_StartIsNull() throws ParseException {
        TimeInterval ti = new TimeInterval(null, DF.parse("01.01.2020"), "");
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_EndIsNull() throws ParseException {
        TimeInterval ti = new TimeInterval(DF.parse("01.01.2020"), null, "");
    }
    
    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_StartIsSameAsEnd() throws ParseException {
        TimeInterval ti = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.01.2020"), "");
    }
    ...
    public void testConstructor_String_StartIsNull() throws ParseException {
        TimeInterval ti = new TimeInterval(null, "01.01.2020");
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_String_EndIsNull() throws ParseException {
        TimeInterval ti = new TimeInterval("01.01.2020", null);
    }

    @Test(expected = IllegalArgumentException.class)
    public void testConstructor_String_StartIsSameAsEnd() throws ParseException {
        TimeInterval ti = new TimeInterval("01.01.2020", "01.01.2020");
    }
//</editor-fold>
...
//<editor-fold defaultstate="expanded" desc="dynamic methods tests">
    ...
    public void testGetStart() throws ParseException {
        TimeInterval ti = new TimeInterval(DF.parse("01.01.2020"), DF.parse("31.12.2020"), "");
    ...
    public void testGetDuration_OneDay() throws ParseException {
        TimeInterval ti = new TimeInterval(DF.parse("01.01.2020"), DF.parse("02.01.2020"), "");
    ...
    public void testGetDuration_StartsInPastInfinity() throws ParseException {
        TimeInterval ti = new TimeInterval(TimeInterval.PAST_INFINITY, DF.parse("02.01.2020"), "");
        assertNull(ti.getDuration());
    }
    
    @Test
    public void testGetDuration_EndsInFutureInfinity() throws ParseException {
        TimeInterval ti = new TimeInterval(DF.parse("01.01.2020"), TimeInterval.FUTURE_INFINITY, "");
        assertNull(ti.getDuration());
    }
    ...
    public void testSucceeds_AprilSuccJanuary() throws ParseException {
        TimeInterval jan = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval apr = new TimeInterval(DF.parse("01.04.2020"), DF.parse("01.05.2020"), "");
    ...
    public void testSucceeds_TouchingIntervals_FebSuccJan() throws ParseException {
        TimeInterval jan = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval feb = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
    ...
    public void testSucceeds_SameOrEqualIntervals() throws ParseException {
        TimeInterval jan1 = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval jan2 = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
    ...
    public void testSucceeds_OverlappingIntervals() throws ParseException {
        TimeInterval january       = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval midJan2MidFeb = new TimeInterval(DF.parse("15.01.2020"), DF.parse("15.02.2020"), "");
    ...
    public void testTouches_OneDayBetweenPreFirst() throws ParseException {
        TimeInterval jan = new TimeInterval(DF.parse("01.01.2020"), DF.parse("31.01.2020"), "");
        TimeInterval feb = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
    ...
    public void testTouches_Overlapping() throws ParseException {
        TimeInterval jan = new TimeInterval(DF.parse("01.01.2020"), DF.parse("31.01.2020"), "");
        TimeInterval mid = new TimeInterval(DF.parse("15.01.2020"), DF.parse("15.02.2020"), "");
    ...
    public void testContains_TimeInterval_AtStart() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.02.2020"), DF.parse("07.02.2020"), "");
    ...
    public void testContains_TimeInterval_AtEnd() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("22.02.2020"), DF.parse("01.03.2020"), "");
        assertTrue(tiA.contains(tiB));
    }
    ...
    public void testContains_TimeInterval_OverlappingAtEnd() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("22.02.2020"), DF.parse("10.03.2020"), "");
    ...
    public void testContains_TimeInterval_OverlappingAtStart() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("22.01.2020"), DF.parse("10.02.2020"), "");
        assertFalse(tiA.contains(tiB));
    }
    ...
    public void testContains_TimeInterval_TouchingAtEnd() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.03.2020"), DF.parse("10.03.2020"), "");
        assertFalse(tiA.contains(tiB));
    }
    ...
    public void testContains_TimeInterval_TouchingAtStart() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("22.01.2020"), DF.parse("01.02.2020"), "");
        assertFalse(tiA.contains(tiB));
    }
    ...
    public void testOverlaps_EqualOrSame() throws ParseException {
        TimeInterval feb1 = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval feb2 = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
    ...
    public void testOverlaps_Containing() throws ParseException {
        TimeInterval jan = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval mid = new TimeInterval(DF.parse("10.01.2020"), DF.parse("20.01.2020"), "");
    ...
    public void testIntersect_OverlappingAtStart() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("22.01.2020"), DF.parse("10.02.2020"), "b");
        TimeInterval intersect = new TimeInterval(DF.parse("01.02.2020"),
                DF.parse("10.02.2020"),
                "(a).intersect(b)");
    ...
    public void testIntersect_OverlappingAtEnd() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("22.02.2020"), DF.parse("10.03.2020"), "b");
        TimeInterval intersect = new TimeInterval(DF.parse("22.02.2020"),
                DF.parse("01.03.2020"),
                "(a).intersect(b)");
        assertEquals(intersect, tiA.intersect(tiB));
    }
    ...
    public void testIntersect_ContainingSecond() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("10.02.2020"), DF.parse("12.02.2020"), "b");
        TimeInterval intersect = new TimeInterval(DF.parse("10.02.2020"),
                DF.parse("12.02.2020"),
                "(a).intersect(b)");
        assertEquals(intersect, tiA.intersect(tiB));
    }
    ...
    public void testIntersect_SndContainingFirst() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("10.02.2020"), DF.parse("12.02.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "b");
        TimeInterval intersect = new TimeInterval(DF.parse("10.02.2020"),
                DF.parse("12.02.2020"),
                "(a).intersect(b)");
        assertEquals(intersect, tiA.intersect(tiB));
    ...
    public void testIntersect_NotTouchingIntervals() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("01.04.2020"), DF.parse("01.05.2020"), "b");
    ...
    public void testIntersect_TouchingIntervals() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("01.03.2020"), DF.parse("01.04.2020"), "b");
        assertNull(tiA.intersect(tiB));
    }
    @Test
    public void testIntersect_IntervalBeforeFirstStart() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("15.03.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("01.03.2020"), DF.parse("01.04.2020"), "b");
        TimeInterval intersect = new TimeInterval(DF.parse("01.03.2020"),
                DF.parse("15.03.2020"),
                "(a).intersect(b)");
        assertEquals(intersect, tiA.intersect(tiB));
    }
    ...
    public void testUnion_SeparateIntervals() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("01.03.2020"), DF.parse("01.04.2020"), "b");
    ...
    public void testUnion_TouchingIntervals() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "b");
        TimeInterval tiE = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.03.2020"), "(a).union(b)");
        assertEquals(tiE, tiA.union(tiB));
    }
    
    @Test
    public void testUnion_OverlappingIntervals() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.03.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.04.2020"), "b");
        TimeInterval tiE = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.04.2020"), "(a).union(b)");
        assertEquals(tiE, tiA.union(tiB));
    }
    ...
    public void testSub_NotOverlapping() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval[] tiE = new TimeInterval[]{
            new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "")};
    ...
    public void testSub_OverlappingAtEnd() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("15.01.2020"), DF.parse("01.03.2020"), "");
        TimeInterval[] tiE = new TimeInterval[]{
            new TimeInterval(DF.parse("01.01.2020"), DF.parse("15.01.2020"), "")};
        assertArrayEquals(tiE, tiA.sub(tiB));
    }
    ...
    //   |---|
    // |---|
    public void testSub_OverlappingAtStart() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("15.01.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval[] tiE = new TimeInterval[]{
            new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "")};
        assertArrayEquals(tiE, tiA.sub(tiB));
    }
    ...
    // |---|
    // |-|
    public void testSub_ContainsAtBegin() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.01.2020"), DF.parse("15.01.2020"), "");
        TimeInterval[] tiE = new TimeInterval[]{
            new TimeInterval(DF.parse("15.01.2020"), DF.parse("01.02.2020"), "")};
        assertArrayEquals(tiE, tiA.sub(tiB));
    }
    ...
    public void testSub_ContainingComplete() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.04.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval[] tiE = new TimeInterval[]{
            new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), ""),
            new TimeInterval(DF.parse("01.03.2020"), DF.parse("01.04.2020"), "")};
        assertArrayEquals(tiE, tiA.sub(tiB));
    }
    ...
    public void testSub_ContainedComplete() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.04.2020"), "");
        TimeInterval[] tiE = new TimeInterval[]{};
        assertArrayEquals(tiE, tiA.sub(tiB));
    }
    ...
    public void testSub_ContainingAtStart() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.04.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.03.2020"), "");
        TimeInterval[] tiE = new TimeInterval[]{
            new TimeInterval(DF.parse("01.03.2020"), DF.parse("01.04.2020"), "")};
        assertArrayEquals(tiE, tiA.sub(tiB));
    }
    ...
    public void testSub_ContainingAtEnd() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.04.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.03.2020"), DF.parse("01.04.2020"), "");
        TimeInterval[] tiE = new TimeInterval[]{
            new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.03.2020"), "")};
        assertArrayEquals(tiE, tiA.sub(tiB));
    }
    ...
    public void testBetween_FebResultsBetweenJanAndMarch() throws ParseException {
        TimeInterval jan = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval mar = new TimeInterval(DF.parse("01.03.2020"), DF.parse("01.04.2020"), "");
        TimeInterval feb = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "");
    ...
    public void testBetween_FebResultsBetweenMarchAndJan() throws ParseException {
        TimeInterval jan = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval mar = new TimeInterval(DF.parse("01.03.2020"), DF.parse("01.04.2020"), "");
        TimeInterval feb = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.03.2020"), "().between()");
        assertEquals(feb, mar.between(jan));
    }
    
    @Test
    public void testBetween_OverlappingIntervals() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.03.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("01.02.2020"), DF.parse("01.04.2020"), "");
    ...
    public void testCompareTo_OverlappingFirstStartsBefore() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "");
        TimeInterval tiB = new TimeInterval(DF.parse("02.01.2020"), DF.parse("01.03.2020"), "");
        assertEquals(-1, tiA.compareTo(tiB));
    }
    ...
    public void testEquals_SameIntervalButDifferentCaption() throws ParseException {
        ...
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "a");
        TimeInterval tiB = new TimeInterval(DF.parse("01.01.2020"), DF.parse("01.02.2020"), "b");
        assertTrue(tiA.equals(tiB));
    }
    ...
    public void testToString_FutureInfinity() throws ParseException {
        TimeInterval tiA = new TimeInterval(DF.parse("01.01.2020"), TimeInterval.FUTURE_INFINITY, "a");
        assertTrue(tiA.toString().contains("oo"));
    }
    
    @Test
    public void testToString_PastInfinity() throws ParseException {
        TimeInterval tiA = new TimeInterval(TimeInterval.PAST_INFINITY, DF.parse("01.01.2020"), "a");
        assertTrue(tiA.toString().contains("oo"));
    }
//</editor-fold>
