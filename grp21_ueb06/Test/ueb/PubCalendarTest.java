 ...
 */
public class PubCalendarTest {

    /**
     * Test of getIntervalCount method, of class Calendar.
     */
    @Test
    public void testGetIntervalCount_EmptyCalendar() {
    ...
    public void testGetIntervalCount_TwoElements() throws ParseException {
        Calendar c = new Calendar("01.01.2020", "01.02.2020",
                                  "01.03.2020", "01.04.2020");
        assertEquals(2, c.getIntervalCount());
    }

    /**
     * Test of getInterval method, of class Calendar.
     */
    @Test
    public void testGetInterval_First() throws ParseException {
        Calendar c = new Calendar("01.01.2020", "01.02.2020",
                                  "01.03.2020", "01.04.2020");
        assertEquals(new TimeInterval("01.01.2020", "01.02.2020"), c.getInterval(0));
    }
    ...
    public void testGetInterval_Snd() throws ParseException {
        ...
        assertEquals(new TimeInterval("01.03.2020", "01.04.2020"), c.getInterval(1));
    }
    ...
    public void testGetInterval_Last() throws ParseException {
        Calendar c = new Calendar("01.01.2020", "01.02.2020",
                                  "01.03.2020", "01.04.2020",
                                  "01.05.2020", "01.06.2020");
        assertEquals(new TimeInterval("01.05.2020", "01.06.2020"), c.getInterval(2));
    }
    ...
    public void testEquals_FourSameElements() throws ParseException {
        Calendar c1 = new Calendar("01.01.2020", "01.02.2020",
                                     "01.03.2020", "01.04.2020",
                                     "01.05.2020", "01.06.2020",
                                     "01.07.2020", "01.08.2020");
        Calendar c2 = new Calendar("01.01.2020", "01.02.2020",
                                     "01.03.2020", "01.04.2020",
                                     "01.05.2020", "01.06.2020",
                                     "01.07.2020", "01.08.2020");
    ...
    public void testEquals_FirstOfThreeDiffers() throws ParseException {
        Calendar c1 = new Calendar("01.01.2020", "01.02.2020",
                                     "01.03.2020", "01.04.2020",
                                     "01.05.2020", "01.06.2020");
        Calendar c2 = new Calendar("02.01.2020", "01.02.2020",
                                     "01.03.2020", "01.04.2020",
                                     "01.05.2020", "01.06.2020");
    ...
    public void testToString_IsSurroundedByCurlyBracketAndBlank() throws ParseException {
        Calendar c = new Calendar("01.03.2020", "01.04.2020");
